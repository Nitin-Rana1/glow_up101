const statsData = {
  ...
  values: [20, 60, 100, 90, 50, 75, 80, 70, 85, 40, 65, 45], // Example values (customize as needed)
};
...
const skillsList: Skill[] = [
  ...
  {
    id: 14,
    skillName: "Meal Prep Perfectionist",
  ...
  {
    id: 19,
    skillName: "Fresh Look",
    skillType: "Skincare and Grooming",
  },

  {
    id: 20,
    skillName: "Demon Grip",
    skillType: "Fitness and Health",
  },
];

const skillsNumber = skillsList.length;
const statsNumber = statsData.labels.length;
...
export { buttonLines, skillsList, tipsList, skillsNumber, statsNumber };
